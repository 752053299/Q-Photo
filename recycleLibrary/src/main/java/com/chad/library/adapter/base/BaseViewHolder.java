...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public BaseViewHolder addEditTextChangeListener(@IdRes int textViewId){
        final EditText editText = getView(textViewId);
        if (editText != null){
            editText.addTextChangedListener(new TextWatcherAdapter() {
                @Override
                public void afterTextChanged(Editable s) {
                    if (adapter.getOnEditTextChangeListener() != null) {
                        adapter.getOnEditTextChangeListener().onEditTextChanged(adapter, editText, getClickPosition());
                    }
                }
            });
        }
