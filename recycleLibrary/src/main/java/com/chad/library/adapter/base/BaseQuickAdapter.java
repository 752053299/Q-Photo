...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void clearData(@NonNull List<T> data){
        mData = data;
        notifyDataSetChanged();
    }
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        if (viewHolder == null) {
            Log.i("ChooseBeanFragment", "viewHolder == null");
            return null;
        }
...
//            subItemCount += list.size();
    ...
    public interface OnEditTextChangeListener{
         ...
         * @param editText
         * @param position
         * @return true if the callback consumed the change ,false otherwise
         */
        boolean onEditTextChanged(BaseQuickAdapter adapter, TextView editText, int position);
    }
    ...
    public final OnEditTextChangeListener getOnEditTextChangeListener(){
        return mOnEditTextChangeListener;
    }
